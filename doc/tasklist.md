...
### 8. Факты (Iteration 8) [В ПРОЦЕССЕ]
- [ ] Реализация системы сбора фактов (Facter-like) <!-- id: 8.1 -->
- [ ] Передача фактов от Агента к Мастеру <!-- id: 8.2 -->
- [ ] Использование фактов в манифестах <!-- id: 8.3 -->
